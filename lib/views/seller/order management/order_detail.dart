                    ...
                    order.trangThai==0
                        ?Container(
                          ...
                          child: Row(
                            children: [
                              ElevatedButton(
                                onPressed: (){
                                  orderController.confirmOrder(order.reference.id);
                                  Get.back();
                                },
                        ...
                        ?Container(
                          ...
                          child: Row(
                            children: [
                              ElevatedButton(
                                onPressed: (){
                                  orderController.shippingOrder(order.reference.id);
                                  Get.back();
                                },
                                child: const Text('Giao cho vận chuyển',),
                              ),
                              const SizedBox(width: 20.0,),
                              ElevatedButton(
                                onPressed: (){
                        ...
                        child: Row(
                          children: [
                            ElevatedButton(
                              onPressed: (){
                                orderController.successOrder(order.reference.id);
                                Get.back();
                              },
